...
% classVar: String containing the name of the variable to classify for. Must be a variable field of the featureTable.
...
% classLabels: file x 1 class labels to feed into the classification task.
