...
generateFeatSummary: First script to run. Combines Tierpsy tables with metadata table to generate a combined FeatureTable used for downstream analysis. Subdivides table into forty-worm and five-worm datasets.
